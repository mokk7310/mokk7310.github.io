              ...
              default: e$1.withCtx(() => [
                e$1.createElementVNode("div", _hoisted_3$1, [
                  ...
                  e$1.createVNode(e$1.Transition, {
                    ...
                    default: e$1.withCtx(() => [
                      e$1.createVNode(e$1.unref(Ae), { class: "absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm" }, {
                        default: e$1.withCtx(() => [
    ...
    root: {
      ...
      callBot: (comment) => {
        const members = Array.from(
          comment.querySelectorAll(".root-reply-container .reply-content .jump-link.user")
        );
